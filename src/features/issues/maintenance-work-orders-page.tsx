...
export function MaintenanceWorkOrdersPage() {
  ...
  const save = async (event: FormEvent) => {
    ...
    const user = editor.assigneeType === 'Driver' && editor.assignee ? assignees.find(item => item.id === editor.assignee || item.label.toLowerCase() === editor.assignee.toLowerCase()) : undefined
    const ignoredInvalidUser = editor.assigneeType === 'Driver' && Boolean(editor.assignee) && !user
